...
<head>
	...
	<link rel="stylesheet" href="./prescription/inc/themes/base/jquery.ui.all.css">
    <script src="./prescription/inc/jquery-1.8.0.js"></script>
	<script src="./prescription/inc/jquery.ui.core.js"></script>
	<script src="./prescription/inc/jquery.ui.widget.js"></script>
        <script src="./prescription/inc/jquery.ui.button.js"></script>
        <script src="./prescription/inc/jquery.ui.position.js"></script>
	<script src="./prescription/inc/jquery.ui.dialog.js"></script>
      ...
      <div id="div-1" class="accordion-body collapse in body">
          <form name="from1" method="POST" action="index.php?page=new_prescription" class="form-horizontal"   enctype="multipart/form-data" >
              <div class="form-group">
                    <label for="pass1" class="control-label col-lg-2">id Patient</label>
                                        ...
                                        for($i=0;$i<count($show);$i++)//fetch data
                                          {
                                            ...
                                            echo'<td><input type="radio" name="id" id="id" value="'.$show[$i]['ID_Drugs'].'"/></td>';
