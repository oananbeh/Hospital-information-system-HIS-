...
<body class="padTop53 " >
       ...
       <div id="left">
          ...
          <li class="panel ">
                    ...
                    <ul class="collapse" id="component-nav">
                        ...
                        <li class=""><a href="../Resiption/index.php?page=new_user"><i class="icon-angle-right"></i> New  </a></li>
                         <li class=""><a href="../Resiption/index.php?page=view_user_update"><i class="icon-angle-right"></i> Update </a></li>
                        <li class=""><a href="../Resiption/index.php?page=view_user_delete"><i class="icon-angle-right"></i> Delete </a></li>
                    </ul>
                </li>
                <li class="panel ">
  ...
  switch ($page)
  {
      case '':  ;
          break;
      case 'new_Drugs':include 'new_Drugs.php';
          break;
	  case 'update_Drugs':include 'update_Drugs.php';
          break;
      case 'delete_Drugs':include 'delete_Drugs.php';
          break;
