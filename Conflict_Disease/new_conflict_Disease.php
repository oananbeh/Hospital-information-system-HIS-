...
?>
  ...
  <body>  
      ...
      <div id="div-1" class="accordion-body collapse in body">
          <form name="register" method="POST" action="index.php?page=new_conflict_Disease" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="text4" class="control-label col-lg-2">Disease</label>

                    <div class="col-lg-8">
                        <select name="Disease">
                            <option value="Diabetes"> Diabetes</option>
                            <option value="Pressure disease">Pressure disease </option>
